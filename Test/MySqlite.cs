...
namespace Test.DAL
{
    public class MySqlite  
    {
        ...
        public string AttchDatabase(String attrDBFile, string newDB, string key =null)
        {
            if (attrDBFile == null)
                return "";
            ...
            if (key != null && key.Length != 0) strRet += " Key '" + key + "'";
        ...
        public string AttchDatabase(MySqlite attrDB, string newDB)
        {
            ...
            return AttchDatabase(attrDB.sqliteConnectionString, newDB, attrDB.sqlitePassword);
